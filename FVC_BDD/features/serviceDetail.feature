@ServiceDetail @ServiceDetailSingle
Feature: Validating the details returned from a Service Request.
  ...
  @ServiceInfo @ServiceDetailSingle
  ...
  @relatedmaterial  @relatedmaterialsingle
  ...
  Examples:
    ...
    | "urn:tva:metadata:cs:HowRelatedCS:2012:19" | "urn:mpeg:mpeg7:cs:FileFormatCS:2001:15" | "Service A"       |
